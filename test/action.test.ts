...
describe("GitHub Action", () => {
  ...
  test("declares the v0.10 package, report, build, and upload inputs", async () => {
    ...
    expect(action).toContain('default: "psbt-interop-lab@0.10.0"');
